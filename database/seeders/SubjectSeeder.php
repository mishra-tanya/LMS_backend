...
class SubjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $subjects = [
            // B.A Subjects
            ['subject_name' => 'History of India', 'course_id' => 1, 'image' => null, 'price' => 300,],
            ['subject_name' => 'Political Science - Theory of Politics', 'course_id' => 1, 'image' => null, 'price' => 200,],
            ['subject_name' => 'Sociology - Introduction', 'course_id' => 1, 'image' => null,'price' => 400,],
            ['subject_name' => 'English Literature', 'course_id' => 1, 'image' => null,'price' => 500],

            ['subject_name' => 'Mathematics - Calculus', 'course_id' => 2, 'image' => null,'price' =>600],
            ['subject_name' => 'Physics - Mechanics', 'course_id' => 2, 'image' => null,'price' => 300],
            ...
            ['subject_name' => 'Financial Accounting', 'course_id' => 3, 'image' => null,'price' => 300],
